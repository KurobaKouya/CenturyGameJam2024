...
public class CameraShakerManager : MonoBehaviour
{
    ...
    static Dictionary<string, CameraShakerManager> instanceList = new Dictionary<string, CameraShakerManager>();
    ...
    /// <returns></returns>
    public static CameraShakerManager GetInstance(string name)
    {
        CameraShakerManager c;
    ...
    public CameraShakeInstance Shake(CameraShakeParameters parameters)
    {
        CameraShakeInstance shake = new CameraShakeInstance(parameters.magnitude, parameters.roughness, parameters.fadeInTime, parameters.fadeOutTime);
